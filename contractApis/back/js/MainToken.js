...
const abi = fs.readFileSync(path.join(__dirname, '../abi/', 'MainToken.json'), {'encoding': 'utf8'});
  ...
  return {
    ...
    methods: {
      ...
      INITIAL_SUPPLY: function() {
        return contract.methods.INITIAL_SUPPLY().call();
      },
      decimals: function() {
      ...
      transferFrom: function(__from, __to, __value, options) {
        const txData = contract.methods.transferFrom(__from, __to, __value, ).encodeABI();
        options = {
          ...options,
          data: txData
        };
      ...
      removeFreezableAddress: function(_addr, options) {
        const txData = contract.methods.removeFreezableAddress(_addr, ).encodeABI();
        options = {
          ...options,
          data: txData
        };
      ...
      addTransferableAddresses: function(_addrs, options) {
        const txData = contract.methods.addTransferableAddresses(_addrs, ).encodeABI();
        options = {
          ...options,
          data: txData
        };
      ...
      addTransferableAddress: function(_addr, options) {
        const txData = contract.methods.addTransferableAddress(_addr, ).encodeABI();
        options = {
          ...options,
          data: txData
        };
      ...
      addFreezableAddresses: function(_addrs, options) {
        const txData = contract.methods.addFreezableAddresses(_addrs, ).encodeABI();
        options = {
          ...options,
          data: txData
        };
      ...
      removeTransferableAddresses: function(_addrs, options) {
        const txData = contract.methods.removeTransferableAddresses(_addrs, ).encodeABI();
        options = {
          ...options,
          data: txData
        };
      ...
      decreaseApproval: function(__spender, __subtractedValue, options) {
        const txData = contract.methods.decreaseApproval(__spender, __subtractedValue, ).encodeABI();
        options = {
          ...options,
          data: txData
        };
      ...
      increaseApproval: function(__spender, __addedValue, options) {
        const txData = contract.methods.increaseApproval(__spender, __addedValue, ).encodeABI();
        options = {
          ...options,
          data: txData
        };
      ...
      removeTransferableAddress: function(_addr, options) {
        const txData = contract.methods.removeTransferableAddress(_addr, ).encodeABI();
        options = {
          ...options,
          data: txData
        };
      ...
      removeFreezableAddresses: function(_addrs, options) {
        const txData = contract.methods.removeFreezableAddresses(_addrs, ).encodeABI();
        options = {
          ...options,
          data: txData
        };
